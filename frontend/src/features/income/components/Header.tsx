  ...
  return (
    <div className="md:mt-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0 mb-6 sm:mb-8">
      <div className="flex items-center gap-3">
        <div className="p-2 sm:p-3 bg-gradient-to-br from-green-500/20 to-green-600/10 rounded-xl sm:rounded-2xl shadow-lg border border-green-500/20">
          <HiMiniCurrencyRupee className="text-2xl sm:text-3xl text-green-400" />
        </div>
        <div>
      ...
      >
        ...
        <span className="font-medium text-sm sm:text-base">Add Income</span>
